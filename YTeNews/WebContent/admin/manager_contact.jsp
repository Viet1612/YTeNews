                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form method="get" action="${pageContext.request.contextPath}/contactadmin.do">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="keyname" value="${keyname}" placeholder="Enter username">
                                    ...
                                    <table class="table table-bordered ">
                                        <tr>
                                            <th style="width: 5%">ID</th>
                                                ...
                                                <th style="width: 30%">Messenger</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>			                    		
                                                ...
                                                <button class="btn  btn-sm btn-danger" onclick="comfirmDeleteContact(${contact.contactId});"><i class="fa fa-trash"></i></button>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="7"><span class="pull-right">Page: ${currentpage}  - Total of recorders: ${totalcontact}</span></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
						...
						<table>
							<tr>
								<c:url value="contactadmin.do" var="url_paging">
